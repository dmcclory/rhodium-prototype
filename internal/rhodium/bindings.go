...
func dispatch(a *app, key string, filtering bool, tables ...[]Binding) (tea.Cmd, bool) {
...
func globalBindings() []Binding {
	quitCmd := func(a *app) tea.Cmd { return tea.Quit }
	return []Binding{
		{
		...
		},
		{
			...
			Action: func(a *app) tea.Cmd { return tea.Suspend },
		},
	}
}
...
// no further wiring.
func agentBindings(cfg *Config) []Binding {
	actions := cfg.ActionsResolved()
